...
document
  .getElementById("inorder")
  .addEventListener("click", () => start("inorder"));
document
  .getElementById("preorder")
  .addEventListener("click", () => start("preorder"));
document
  .getElementById("postorder")
  .addEventListener("click", () => start("postorder"));
